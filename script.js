...
var TicTacToe = {
    ...
    setTurnIndicator: function() {
        this.turnIndicator.innerText =  "Tour de : " + this.symbols[this.activePlayer] 
    },
    ...
    play: function(el) {
        ...
        if (!this.gameOver && el.classList.length == 1) {
            ...
            if (this.checkWin()) {
                ...
                this.turnIndicator.innerText = this.symbols[this.activePlayer] + " a gagné";
            ...
            // check if there is a draw
                ...
                this.turnIndicator.innerText = "Match nul !";
                // call the game over function
                this.endGame();
            }
